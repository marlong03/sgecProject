...
@Component({
  selector: 'app-dashboard-administrador-replica',
  templateUrl: './dashboard-administrador-replica.component.html',
  styleUrls: ['./dashboard-administrador-replica.component.css']
})
export class DashboardAdministradorReplicaComponent implements OnInit,OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if(localStorage.getItem('usuario') == null){
      ...
      this.router.navigate(['/dashboardAdminReplica'])
    }
  }
  obtenerPedidos(){
